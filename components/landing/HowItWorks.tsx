...
const steps = [
  {
    number: '1',
    title: 'Регистрация',
    description: 'Зарегистрируйся за 30 секунд. Нужен только email или аккаунт Google.',
    delay: 0.1,
  },
  {
    number: '2',
    title: 'Вводи данные',
    description: 'Записывай шаги, сон, пульс и вес каждый день. Это занимает меньше минуты.',
    delay: 0.2,
  },
  {
    number: '3',
    title: 'Получай советы',
    description: 'AI смотрит на твои данные и каждый день даёт советы — что улучшить в режиме сна, питании или активности.',
    delay: 0.3,
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-5 items-stretch">
            ...
            >
              ...
              <p className="text-[#4a5a8a] text-sm leading-relaxed mt-auto">
                Всё сделано так, чтобы было удобно.
                Без лишних кнопок и сложных настроек.
              </p>
