...
const features = [
  {
    title: 'ОТСЛЕЖИВАНИЕ МЕТРИК',
    description: 'Шаги, сон, пульс и вес — все показатели в одном месте. Удобное добавление данных вручную или через синхронизацию.',
    delay: 0.1,
  },
  {
    title: 'AI-РЕКОМЕНДАЦИИ',
    description: 'На основе анализа ваших трендов интеллектуальная система ежедневно формирует персональные рекомендации.',
    delay: 0.2,
  },
  {
  ...
  },
  {
    ...
    description: 'Ваши данные надёжно защищены. Полный контроль над личной информацией и безопасное хранение на сервере.',
    delay: 0.4,
  },
];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-12">
        ...
        <div className="lg:hidden">
          ...
          >
            ...
            >
              Все необходимое
              <br />для здоровой жизни
            </h2>
            <p className="text-[#4a5a8a] text-sm max-w-sm mx-auto mt-3">
              Четыре ключевых инструмента, которые делают заботу о здоровье простой и эффективной
            </p>
          </motion.div>
